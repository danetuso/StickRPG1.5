    ...
    public final void mouseClicked(int button, Vector location)
    {
        ...
        switch (t)
        {
            ...
            case LOAN:{
                ...
                this.getParentScene().getEntityController(StickEntityController.class).bhouse.setVisible(false);
                break;
            }
            case LOANACCEPT:{
                if(player.loanday == -1)
            ...
            case BHOUSE:{
                sc.textBoxFocused = false;
                if(this.getParentScene().getEntityController(StickEntityController.class).bhouse.isVisible())
